...
class UpdateStatusRequestMapper
  ...
  class MessageData
    include XmlSchemaMapper
    schema 'vendor/ezags-protocols/eZAGS/public/OrderService.xsd'
    annonymus_type 'UpdateStatusRequest::MessageData'
  ...
  class MessageData::AppData
    include XmlSchemaMapper
    schema 'vendor/ezags-protocols/eZAGS/public/OrderService.xsd'
    annonymus_type 'UpdateStatusRequest::MessageData::AppData'

    # @return [UpdateStatusRequestObjMapper]
    # minOccurs: 1, maxOccurs: 1
    attr_accessor :update_status_request_obj
