...
require "xml_schema_mapper/test_builder"
  ...
  # @attr content [ActRecordContentOfMarriage]
  # @attr participants [ParticipantsForMarriage]
  # @attr documentConfirmingGroom [DocumentsConfirmingMarriage]
  # @attr documentConfirmingBride [DocumentsConfirmingMarriage]


describe ActRecordMarriageMapper do
