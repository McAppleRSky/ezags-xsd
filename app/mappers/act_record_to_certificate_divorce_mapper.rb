# encoding: utf-8
# @note Актовая запись о расторжении брака в объеме свидетельства

class ActRecordToCertificateDivorceMapper
  include XmlSchemaMapper
  schema File.expand_path('../../vendor/ezags-protocols/eZAGS/public/UploadService.xsd', File.dirname(__FILE__))
  type 'ActRecordToCertificateDivorce'
  ...
  # Документы обоснования для развода
