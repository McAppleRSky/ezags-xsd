...
require "xml_schema_mapper/test_builder"
  ...
  # @attr content [ActRecordContentOfBirth]
  # @attr participants [ActRecordParticipantsForBirth]
  # @attr documentConfirmingBirth [DocumentsConfirmingBirth]
  # @attr documentConfirmingFiliation [DocumentsConfirmingFiliationForBirth]
  # @attr otherApplicants [OtherApplicants]


describe ActRecordBirthMapper do
