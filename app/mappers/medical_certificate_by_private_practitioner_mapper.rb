# encoding: utf-8
# @note Документ установленной формы о рождении, выданный частнопрактикующим врачем
# 			

class MedicalCertificateByPrivatePractitionerMapper
  include XmlSchemaMapper
  schema 'vendor/ezags-protocols/eZAGS/public/UploadService.xsd'
  type 'MedicalCertificateByPrivatePractitioner'
