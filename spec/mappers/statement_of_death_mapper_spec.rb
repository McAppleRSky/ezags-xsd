...
require "xml_schema_mapper/test_builder"
  ...
  # @attr statementContentOfDeath [StatementContentOfDeath]
  # @attr documentsConfirmingDeath [DocumentsConfirmingDeath]
  # @attr documentsConfirmingPerinatalDeath [DocumentsConfirmingPerinatalDeath]
  # @attr otherApplicants [OtherApplicants]


describe StatementOfDeathMapper do
