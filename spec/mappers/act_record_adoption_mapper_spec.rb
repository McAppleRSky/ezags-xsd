...
require "xml_schema_mapper/test_builder"
  ...
  # @attr content [ActRecordContentOfAdoption]
  # @attr participants [ActRecordParticipantsForAdoption]
  # @attr documentsConfirmingMarriageForAdoption [DocumentsConfirmingMarriageForAdoption]
  # @attr documentsConfirmingAdoption [DocumentsConfirmingAdoption]
  # @attr relatedModifiedDocuments [RelatedModifiedDocumentsForAdoption]
  # @attr otherApplicants [OtherApplicantsForAdoption]


describe ActRecordAdoptionMapper do
